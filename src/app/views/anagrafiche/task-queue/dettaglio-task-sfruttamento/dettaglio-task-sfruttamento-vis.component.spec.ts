...
import {DettaglioTaskSfruttamentoComponent} from './dettaglio-task-sfruttamento.component';


describe('DettaglioTaskSfruttamentoComponent', () => {
  let component: DettaglioTaskSfruttamentoComponent;
  let fixture: ComponentFixture<DettaglioTaskSfruttamentoComponent>;
  ...
  const mockTaskService = {
    ...
    getTaskSfruttamentoAnsyDca: (id: string) =>  of (dataSfruttamento)
  };
  ...
  beforeEach(async(() => {
    TestBed.configureTestingModule({
      ...
      declarations: [ DettaglioTaskSfruttamentoComponent ],
      providers: [
  ...
  beforeEach(() => {
    ...
    fixture = TestBed.createComponent(DettaglioTaskSfruttamentoComponent);
  ...
  it('if user is requestor should not show buttons rifiuta ', () => {
    component.loadSections(dataSfruttamento.id);
