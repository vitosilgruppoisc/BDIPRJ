...
describe('RicercaContiComponent', () => {
  ...
  it('should create', () => {
    ...
    const req4 = httpTestingController.expectOne('/tipiParty');
  ...
  it('should not search if not valid', () => {
    component.bicParty.setValue('A');
    component.submit(el, true);
    const req = httpTestingController.expectNone('/conti?bicParty=A');
    const req4 = httpTestingController.expectOne('/tipiParty');
    const req1 = httpTestingController.expectOne('/filiali');
    const req2 = httpTestingController.expectOne('/tipiConto');
    const req3 = httpTestingController.expectOne('/tipiTargetService');
  ...
  it('should search if valid', () => {
    component.submit(el, true);
    const req = httpTestingController.expectOne('/conti?');
